...
vignette: >
  %\VignetteIndexEntry{CardioDataSets: A Comprehensive Collection of Cardiovascular and Heart Disease Datasets}
...
## All datasets within CardioDataSets

```{r CardioDataSets-datasets,echo = TRUE,message = FALSE,warning = FALSE,results = 'markup'}
